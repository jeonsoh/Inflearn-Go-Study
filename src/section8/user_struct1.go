...
func main()  {
  ...
  //구조체와 메소드 연결을 통해서 타 언어의 클래스 형식처럼 사용 가능 (객체지향 )

  //예제1
  bmw := Car{name :"520d", price: 50000, color: "white", tax: 5000}
  benz := Car{name :"220d", price: 60000, color: "white", tax: 6000}
  ...
  // fmt.Println("ex2: ", Price(bmw)) //이렇게는 사용하지 않음
